...
public class PL0BaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PL0Visitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitRelOperator(PL0Parser.RelOperatorContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitConstant(PL0Parser.ConstantContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
